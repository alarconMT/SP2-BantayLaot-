...
\renewcommand{\TITLE}{BANTAYLAOT+: AN ENHANCED SYSTEM FOR OFFLINE AND SECURE MONITORING OF PHILIPPINE MUNICIPAL FISHERIES WITH AI INTEGRATION PREPAREDNESS}
\renewcommand{\AUTHOR}{MAGENTA T. ALARCON}
...
\begin{document}
	...
	\begin{frontmatter}
		...
		\begin{approvalpage}
			...
			\begin{multicols}{2}
				\centering
				\addsignature{RIZZA D.C. MERCADO}{Member, Panel Committee} %custom command for adding signature field
				\columnbreak
				\addsignature{ARIEL B. DORIA}{Member, Panel Committee}
			\end{multicols}
		...
		\begin{biosketch}
            ...
            Born in Las Pinas City, Metro Manila, Her academic interests include software development, web and mobile technologies, and information systems. As part of her undergraduate studies, she worked on the enhancement of BantayLaot+, a mobile and web-based fisheries monitoring system designed to support municipal fisheries management in the Philippines.

            She aspires to contribute to the development of technology-driven solutions that address real-world challenges and promote sustainable development.
		...
		\begin{acknowledgement}
			I would like to express my sincere gratitude to everyone who contributed to the completion of this study.

            First and foremost, I extend my deepest appreciation to Dr. Val Randolf M. Madrid, my adviser, for his invaluable guidance, expertise, patience, and continuous support throughout the conduct of this research.

            I would also like to thank the faculty members of the Institute of Computer Science, University of the Philippines Los Baños, for equipping me with the knowledge and skills necessary to undertake this study.

            Most importantly, I am deeply grateful to my parents, Juliet Alarcon and Eugene Alarcon, for their unwavering love, encouragement, sacrifices, and support throughout my academic journey. Their belief in me has been a constant source of strength and motivation.

            Finally, I would like to thank my friends and classmates for their encouragement, understanding, and companionship throughout the challenges and milestones of this endeavor.

            To all who contributed, directly or indirectly, to the successful completion of this research, I offer my heartfelt thanks.
		\end{acknowledgement}
		...
		\\Major Professor: PROF. VAL RANDOLF M. MADRID\\
...
\begin{figure}[h]
    \centering
    \includegraphics[width=350px]{Texfiles/figures/system_architecture.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=400px]{Texfiles/figures/Pre-Departure.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=400px]{Texfiles/figures/At Sea.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=400px]{Texfiles/figures/Landing.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=350px]{Texfiles/figures/Synchronization.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=400px]{Texfiles/figures/web_workflow_munic.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=400px]{Texfiles/figures/web_workflow_central.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=400px]{Texfiles/figures/web_workflow_researcher.png}
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=150px]{Texfiles/figures/mobile_login.jpg}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=150px]{Texfiles/figures/mobile_home.jpg}
    \end{minipage}

    \caption{Mobile Application --- Login Screen (left) and Home Dashboard (right).}
    \label{fig:mobile_interfaces}
\end{figure}

Upon launching the application, fisherfolk authenticate using credentials issued by the
municipal administrator, as shown in Fig.~\ref{fig:mobile_interfaces}. JWT tokens received
...
(Fig.~\ref{fig:mobile_interfaces}), which presents the current session status and provides
...
\begin{figure}[h]
    \centering
    \includegraphics[width=150px]{Texfiles/figures/mobile_predeparture.jpg}
...
% \begin{figure}[h]
%     \centering
%     \includegraphics[width=150px]{Texfiles/figures/mobile_atsea.jpg}
...
% \begin{figure}[h]
%     \centering
%     \includegraphics[width=150px]{Texfiles/figures/mobile_violation.jpg}
...
\begin{figure}[h]
    ...
    \caption{Mobile Application --- At Sea (left) and Violation Report (right).}
    \label{fig:mobile_interfaces2}
\end{figure}

Fig.~\ref{fig:mobile_interfaces2} shows the active session view displayed during at-sea
...
reporting form shown in Fig.~\ref{fig:mobile_interfaces2}, which allows capture of a
...
\begin{figure}[h]
    \centering
    \includegraphics[width=150px]{Texfiles/figures/mobile_catch.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=425px]{Texfiles/figures/web_munic_overview.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=425px]{Texfiles/figures/web_munic_sessions.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=425px]{Texfiles/figures/web_munic_violations.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=350px]{Texfiles/figures/web_munic_map.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=425px]{Texfiles/figures/web_munic_users.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=425px]{Texfiles/figures/web_central_overview.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=425px]{Texfiles/figures/web_central_cpue.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=425px]{Texfiles/figures/web_researcher_summary.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=425px]{Texfiles/figures/web_researcher_fishers.png}
